...
[WAV Trigger Firmware v1.40](https://github.com/gpstar81/GPStar-proton-pack/extras/sound/WavTrigger/WAVTrig_20231001_v140.hex?raw=1) - Custom firmware for GPStar equipment, not available via manufacturer's website.
